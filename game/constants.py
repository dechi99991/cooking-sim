...
# 給料・ボーナス
SALARY_AMOUNT = DEFAULT_CONFIG.salary_amount
SALARY_DAY = DEFAULT_CONFIG.salary_day
BONUS_AMOUNT = DEFAULT_CONFIG.bonus_amount
BONUS_MONTHS = DEFAULT_CONFIG.bonus_months

# カフェイン
CAFFEINE_INSOMNIA_THRESHOLD = DEFAULT_CONFIG.caffeine_insomnia_threshold
CAFFEINE_ENERGY_PENALTY = DEFAULT_CONFIG.caffeine_energy_penalty
CAFFEINE_STAMINA_PENALTY = DEFAULT_CONFIG.caffeine_stamina_penalty
