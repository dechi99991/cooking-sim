...
- **対応:** 食材に「購入日」フィールドを追加し、レリック取得日以降の食材のみ延長適用
- **関連ファイル:** `game/ingredients.py`, `game/day_cycle.py`
...
### 3. 買い物バッグ上限 + 拡張アイテム
- **内容:** 1回の買い物で持てる量に制限（例: 5個）
- **拡張:** エコバッグ等のレリックで上限増加
- **関連ファイル:** `game/constants.py`, `game/relic.py`, `main.py`
